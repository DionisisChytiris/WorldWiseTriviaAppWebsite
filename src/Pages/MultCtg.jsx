  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-[70%] pt-0 mt-24 mx-auto overflow-x-visible ">
          {/* <div className="mb-32">
        ...
        <ImageCarousel images={images}/>
          ...
          <Slider {...settings}>
            {images.map((src, index) => (
              <div
                key={index}
                className="p-2 ml-10 transition-transform duration-300"
              >
                <img
                  src={src}
                  alt={`slide-${index}`}
