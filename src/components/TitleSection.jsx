  ...
  return (
    <header className="relative overflow-hidden">
      <div
        ...
        id="section1"
      >
        <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-bold text-customBlue dark:text-white mb-2 lg:mb-8" >
          {t("title1")}
        </h1>
        {/* <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-6xl font-bold text-gray-900 mb-4 lg:mb-6"> */}
        <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-7xl xl:text-7xl font-bold text-customBlue dark:text-white mb-4 md:mb-5 lg:mb-12">
          {t("title2")}
        </h1>
        ...
        <p className="px-10 text-xl sm:text-xl lg:text-2xl text-gray-500 dark:text-gray-200 font-medium pb-20 pt-10 max-w-3xl mx-auto"  id='download-buttons'>
          {t("subtitle1")}       
        </p>
        ...
        <div className="mt-32 mb-20">
         ...
         <div className="px-10 text-xl sm:text-xl lg:text-2xl text-gray-500  dark:text-gray-400 font-medium max-w-3xl mx-auto pt-20 pb-20">
         {t("subtitle2")}
        </div>
      </div>
    </header>
